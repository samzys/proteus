...
public class AffineTransform implements Cloneable, java.io.Serializable {
	 ...
	 */
	/*
	 * public Object clone() { try { throw new CloneNotSupportedException(); }
	 * catch (CloneNotSupportedException e) { // this shouldn't happen, since we
	 * are Cloneable throw new InternalError(); } }
	 */
	/**
	 ...
	 */
	/*
	 * public int hashCode() { long bits = Double.doubleToLongBits(m00); bits =
	 * bits * 31 + Double.doubleToLongBits(m01); bits = bits * 31 +
	 * Double.doubleToLongBits(m02); bits = bits * 31 +
	 * Double.doubleToLongBits(m10); bits = bits * 31 +
	 * Double.doubleToLongBits(m11); bits = bits * 31 +
	 * Double.doubleToLongBits(m12); return (((int) bits) ^ ((int) (bits >>
	 * 32))); }
	 */
	/**
